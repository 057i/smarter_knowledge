...
if __name__ == "__main__":
    ...
    if not os.path.exists(test_pdf_path):
        ...
        test_state = ImportGraphState({
            ...
            "is_pdf_read_enable": False,  # 开启PDF解析（核心开关）
            "is_md_read_enable": False  # 关闭MD解析
        })
        try:
            ...
            final_state = None
            for step in knowledge_import_graph.stream(test_state, stream_mode="values"):
                # 打印当前执行完成的节点（流式输出更直观）
